...
<div class="callout callout-info">
    ...
    <p>
        ...
        <label>Assunto:</label> <span id="assunto_chamado"><?php echo $chamado_info['assunto']; ?></span><br>
        <label>Cadastro Por:</label> <?php echo $chamado_info['cadastrado']; ?><br>
        <label>Data:</label> <?php echo date('d/m/Y', strtotime($chamado_info['dt_cadastro'])). ' - ' . $chamado_info['hr_cadastro'] . 'h'; ?><br>
...
<?php } else { ?>
    <div class="callout callout-warning">
        <p>Chamado Não Iniciado! <br>Por favor, Aguarde a Atualização do Setor Responsavel!</p>
    </div>
<?php } ?>
...
<?php if (intval($chamado_info['id_status']) == 20 || intval($chamado_info['id_status']) == 40  || intval($chamado_info['id_status']) == 40) { ?>
    <hr>
...
<?php } else if(intval($chamado_info['id_status']) == 1){ ?>
    <hr>
    <div class="callout callout-warning">
        <p>Chamado Não Iniciado! <br>Por favor, Aguarde a Atualização do Setor Responsavel!</p>
    </div>
<?php } else if(intval($chamado_info['id_status']) == 30 || intval($chamado_info['id_status']) == 50){ ?>
    <hr>
    <div class="callout callout-warning">
        <p>Chamado Finalizado! <br></p>
    </div>
<?php } ?>
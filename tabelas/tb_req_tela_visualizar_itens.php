...
<table class="table table-sm table-striped dataTable js-exportable table-bordered">
    ...
    <tbody>
      ...
      $sql = "SELECT i.id as itemId, i.nome as item, i.referencia as referencia, i.marca as marca, i.modelo as modelo, e.qtd_slt as solicitado, e.qtd_env as enviado , e.qtd_ent as recebida, s.status as status
      FROM estoque_registro_requisicao r 

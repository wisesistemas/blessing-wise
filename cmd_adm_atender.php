...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#cmd_adm_atender").addClass('fas fa-circle nav-icon');
            ...
            function carregarTabela() {
                $.ajax({
                    url: "tabelas/tb_cmd_amd_chamados.php",
                    type: "POST",
            ...
            $(document).on('click', '.editar', function() {
                ...
                $.ajax({
                    url: "tabelas/tb_cmd_adm_atender.php",
                    type: "POST",
                    data: {
                        chamado: chamado
                    },
            ...
            $(document).on('click', '#assunto_chamado', function() {
                alert('ok');
            })

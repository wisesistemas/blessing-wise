...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getTabelaAtual(_unidade) {

                $.ajax({
                    url: "validar/validar.php?id=30",
                    type: "POST",
                    data: {
                        unidade: _unidade
                    },
                    success: function(data) {
                        $.ajax({
                            url: "tabelas/tb_lista_compra.php",
                            success: function(data) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="unidade_id">Selecione o item:</label>
                                            <select class="form-control form-control-sm select2" style="width: 100%;" id="unidade_id" name="unidade_id">
                                                <option selected="selected" value="">...</option>
                                                <?php
                                                $sql = "SELECT * FROM cad_unidade where ativo = 1";
                                                $sql = mysqli_query($link, $sql);
                                                while ($sqlUnidade = mysqli_fetch_array($sql)) {
                                                ?>
                                                    <option value="<?php echo $sqlUnidade['id'] ?>"><?php echo $sqlUnidade['nome'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>

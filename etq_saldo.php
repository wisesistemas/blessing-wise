...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#set_etq_saldo").addClass('fas fa-circle nav-icon');
            getTabela();
            function getTabela() {
                $.ajax({
                ...
                data: { unidade: <?php echo$_SESSION['usuario_id_unidade']; ?>},
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Saldo estoque</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Saldo Unidade</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Saldo estoque:</h3>
                        ...
                        <!-- /.card-header -->
                        <div class="table-responsive" id="tb_itens"></div>
                        <!-- ./wrapper -->

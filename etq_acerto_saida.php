...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#set_etq_acerto_saida").addClass('fas fa-circle nav-icon');
        ...
        $("#salvar").click(function() {
            $("#loading1").show();
            $.ajax({
                url: "validar/validar.php?id=3&prmt=4",
                type: "POST",
                beforeSend: function(){
                    $("#tb_itens").hide();
                    $("#button").hide();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Acerto de saída</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Acerto De Saída De Material</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default  elevation-1">
                        <div class="card-header">
                            <h3 class="card-title">Acerto de saída:</h3>

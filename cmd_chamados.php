...
$sqlUnidade = mysqli_query($link, $sql1);
...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#cmd_chamados").addClass('fas fa-circle nav-icon');
            ...
            function carregarTabela() {
                $.ajax({
                    url: "tabelas/tb_cmd_chamados.php",
                    type: "POST",
...
<body class="hold-transition sidebar-mini layout-fixed text-sm">
    ...
    <div class="overlay-wrapper">
        <div class="overlay" id="loading2" style="display: none"><i class="fas fa-3x fa-sync-alt fa-spin"></i>
        <div class="text-bold pt-2">Preparando dados do chamado.</div>
    </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark"><strong>Chamados - TI:</strong>
                                </h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active"><strong>Chamados - TI:</strong></li>
                                </ol>
                    ...
                    <div class="container-fluid ">
                        ...
                        <div class="card card-default elevation-1">
                            <div class="card-header">
                                <h3 class="card-title">Chamados - TI:</h3>
                                                ...
                                                <form id="form">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label for="nome">Quem o Setor de TI Deve Procurar</label>

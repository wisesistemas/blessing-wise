...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".util-relatorio").addClass('menu-open');
            $("#util_rel_tabela_exames").addClass('fas fa-circle nav-icon');
            ...
            $("#inserir").click(function() {
                var tabela = $('#unidade').val();
                $("#loading1").show();
                $.ajax({
                    url: "tabelas/tb_util_relatorio_tb_exames.php",
                    type: "POST",
                    beforeSend: function() {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Relatório tabela faturamento</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Relatório tabela faturamento</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default elevation-1" >
                        <div class="card-header">
                            <h3 class="card-title">Relatório tabela faturamento:</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label>Selecione a tebela:</label>
                                            <select class="form-control form-control-sm select2" style="width: 100%;" id="unidade" name="unidade">
                                                <option selected="selected" value="0">Todas</option>
                                                <?php
                                                $sql = "SELECT * FROM desc_tabelas WHERE ativo = 1";
                                                $sql = mysqli_query($link, $sql);
                                                
                                                while ($sqlItem = mysqli_fetch_array($sql)) {
                                                ?>
                                                    <option value="<?php echo $sqlItem['id'] ?>"><?php echo $sqlItem['tabela'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>

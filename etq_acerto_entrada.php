...
<head>
    ...
    $(document).ready(function() {
        ...
        $(".estoque_acertos").addClass('menu-open');
        $("#set_etq_acerto_entrada").addClass('fas fa-circle nav-icon');
        ...
        $("#salvar").click(function() {
            $("#loading1").show();
            $.ajax({
                url: "validar/validar.php?id=3&prmt=3",
                type: "POST",
                beforeSend: function(){
                    $("#tb_itens").hide();
                    $("#button").hide();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Acerto de entrada</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Acerto De Entrada De Material</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default elevation-1">
                        <div class="card-header">
                            <h3 class="card-title">Acerto de entrada:</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control form-control-sm" name="qtd"
                                                id="qtd" placeholder="Quantidade">
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="display: none" id="button">
                            <div class="col-md-12 text-right">
                                <a class="btn btn-app btn-sm elevation-1" id="cancelar" data-toggle="tooltip" data-placement="top"
                                    title="Cancelar todos os itens.">
                                    <i class="fas fa-times"
                                        style="font-size: 24px; color: red"></i></i><strong>Cancelar</strong>
                                </a>
                                <a class="btn btn-app btn-sm elevation-1" id="salvar" data-toggle="tooltip" data-placement="top"
                                    title="Salvar.">
                                    <i class="far fa-save "

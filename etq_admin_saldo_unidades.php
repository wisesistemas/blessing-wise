...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#rel_saldo_unidade").addClass('fas fa-circle nav-icon');
            ...
            $("#inserir").click(function() {
                ...
                var zerado = $('#zerado').val();
                $("#loading1").show();
                $.ajax({
                    url: "tabelas/tb_etq_saldo.php",
                    type: "POST",
                    beforeSend: function() {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Reletório saldo unidade</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Reletório Estoque</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default elevation-1">
                        <div class="card-header">
                            <h3 class="card-title">Reletório saldo unidade:</h3>
                    ...
                    <div class="row" style="display: none" id="button">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-app btn-sm" id="cancelar" data-toggle="tooltip" data-placement="top" title="Cancelar todos os itens.">
                                <i class="fas fa-times" style="font-size: 24px; color: red"></i></i><strong>Cancelar</strong>
                            </a>
                            <a class="btn btn-app btn-sm" id="salvar" data-toggle="tooltip" data-placement="top" title="Salvar.">

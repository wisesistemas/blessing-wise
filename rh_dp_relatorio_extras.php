...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".rh_dp_relatorio").addClass('menu-open');
            $("#rh_do_relatorio_extras").addClass('fas fa-circle nav-icon');
            ...
            $("#gerar").click(function() {
                ...
                $("#loading1").show();
                $.ajax({
                    url: 'tabelas/ul.extras_relatorio.php',
                    type: 'POST',
                    beforeSend: function() {
            ...
            $(document).on('click', '.extra', function() {
                $("#loading1").show();
                $.ajax({
                    url: 'tabelas/tb_rh_do_relatorio.php',
                    type: 'POST',
                    data: {
                        query_extras: $(this).attr('id')
                    },
                    success: function(data) {
                        console.log(data);
                        $("#loading1").hide();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Relatório de extras</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active"><strong>Relatório de extras</strong></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Relatório de extras:</h3>
                        ...
                        <form id="form12" class="col-md-12 my-2">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control form-control-sm select2" name="status[]" id="status" required multiple>
                                        <?php
